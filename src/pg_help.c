...
static const PgHelpItem it_bend[] = {
    T("A chamber for a low-speed engine is long — over three metres for the "
      ...
      "can turn."),
    R("1  Select a joint", "Click a joint ring in the view, or use Page Up and "
                           "Page Down to step along the chamber."),
    ...
    R("3  Check it",       "Red pieces clash. The overlay and the status strip "
                           "say what with."),
