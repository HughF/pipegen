...
/*
 * Dark is the default: it keeps the 3D view the brightest thing on screen.
 * often as on deck in daylight.
 */
const PgTheme PG_THEME_DARK = {
    .is_light        = false,
    ...
    .trace_a         = C(255, 196,  84),   /* plugging pulse — amber     */
    .trace_b         = C( 92, 178, 255),   /* suction wave — blue       */
    .trace_c         = C(122, 214, 154),   /* timing window — green     */
    .trace_d         = C(198, 142, 232),   /* auxiliary — violet        */
    .scrim           = CA(  8,   9,  12, 190),
};

const PgTheme PG_THEME_LIGHT = {
    .is_light        = true,
    ...
    .trace_a         = C(184, 116,   8),   /* plugging pulse — amber     */
    .trace_b         = C( 24,  96, 200),   /* suction wave — blue       */
    .trace_c         = C( 26, 132,  76),   /* timing window — green     */
    .trace_d         = C(122,  60, 176),   /* auxiliary — violet        */
    .scrim           = CA( 30,  36,  46, 120),
};

void pg_theme_apply(struct nk_context *ctx, const PgTheme *t, float scale)
{
